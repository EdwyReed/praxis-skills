...
Apply test design techniques from praxis-test-design-techniques skill.
...
**Як застосовувати** — прочитай `praxis-test-design-techniques` skill:
1. Визнач HOME через `Bash`: `echo $HOME`
2. Прочитай файл через `Read`: `$HOME/.claude/skills/praxis-test-design-techniques/SKILL.md`
