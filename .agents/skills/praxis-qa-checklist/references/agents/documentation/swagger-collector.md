...
When `praxis-stoplight-docs` skill is loaded, enforce these conventions during generation:
...
> Full Stoplight conventions reference: `skills/praxis-stoplight-docs/SKILL.md`
