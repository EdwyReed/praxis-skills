...
When `praxis-stoplight-docs` skill is loaded, use SMD syntax. Articles degrade gracefully to plain markdown in GitHub/VS Code.
...
### Task 4: Stoplight Packaging (when praxis-stoplight-docs skill is loaded)
