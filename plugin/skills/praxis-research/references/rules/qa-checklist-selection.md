# Rule for selecting pre-defined checklists for Checklist-based Testing technique

Pre-defined checklists are defined in the praxis-test-design-techniques skill (Checklist-based Testing section).
