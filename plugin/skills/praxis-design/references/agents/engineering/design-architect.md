...
> **Note:** Якщо в проєкті є template skills (praxis-design-template, praxis-adr-template, praxis-api-contracts-template), використовуй їх замість форматів нижче. Формати нижче — fallback.
